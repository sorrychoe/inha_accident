...
추가로, 7월 15일부터 10월 15일의 기간에 보도된 기사 중, 해당 사건과 관련 없는 기사를 필터링하였다. 기사 필터링은 Python으로 진행하였으며, 해당 내용은 "1. Clustering analysis을 중심으로" 편에서 다룬다.
